                        ...
                        <div class="flex-1">
                            <div class="flex justify-between items-center">
                                <div>
                                    ...
                                    <small
                                        class="ml-2 text-sm text-gray-600">{{ $resource->created_at->format('j M Y, g:i a') }}</small>
                                </div>
                            </div>
                            ...
                            <div class="mt-4">
                                ...
                                @else
                                    {{-- If the file is not an image (e.g., PDF), show the filename --}}
                                    <p class="text-sm text-gray-600">
                                        <strong>File:</strong> {{ basename($resource->file_path) }}
                                    </p>
                                @endif
                            </div>
                        </div>
